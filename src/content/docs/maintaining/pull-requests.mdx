...
<Aside type="tip">All of the above are generally covered by our [branch protection rules](https://help.github.com/en/github/administering-a-repository/about-protected-branches) so nothing extra is required from the reviewer.</Aside>
...
<Aside type="tip">Be sure to check out the list of browsers and devices we support listed below when testing out a PR. All features should function the same in each one, but don't necessarily require that they all match in design.</Aside>
